                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @foreach ($products as $products)
                                    <tr>
                                        <td>
                                            <p class="text-xs px-4 font-weight-bold mb-0">{{ $products->id }}</p>
                                        </td>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT93guhRmR-wi6d5Hspd-BM9HglKtB57xWr_Q&s" class="avatar avatar-sm me-3"
                                                        alt="user1">
                                                </div>
                                        ...
                                        <td class="align-middle">
                                            <form action="{{ route('product_types.destroy', $products->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
